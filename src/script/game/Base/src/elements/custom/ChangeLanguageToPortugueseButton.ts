/**
 * ChangeLanguageToPortugueseButton.ts
 *
 * Auto-generated documentation comment for script/game/base/src/elements/custom/ChangeLanguageToPortugueseButton.ts.
 */
...
/**
 * ChangeLanguageToPortugueseButton
 *
